    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Booking>().HasData(
                new Booking { BookingId = 1, EventId = 1, VenueId = 1, EventDate = new DateTime(2026, 4, 15), StartTime = new TimeSpan(9, 0, 0), EndTime = new TimeSpan(17, 0, 0), BookedBy = "Thandi Mokoena" },
                new Booking { BookingId = 2, EventId = 2, VenueId = 2, EventDate = new DateTime(2026, 5, 10), StartTime = new TimeSpan(14, 0, 0), EndTime = new TimeSpan(23, 0, 0), BookedBy = "Sipho Dlamini" },
                new Booking { BookingId = 3, EventId = 3, VenueId = 6, EventDate = new DateTime(2026, 12, 5), StartTime = new TimeSpan(18, 0, 0), EndTime = new TimeSpan(23, 30, 0), BookedBy = "Zephyr Corp Events Team" },
                new Booking { BookingId = 4, EventId = 4, VenueId = 3, EventDate = new DateTime(2026, 6, 1), StartTime = new TimeSpan(7, 0, 0), EndTime = new TimeSpan(12, 0, 0), BookedBy = "Sunshine Charity" },
                new Booking { BookingId = 5, EventId = 5, VenueId = 7, EventDate = new DateTime(2026, 7, 20), StartTime = new TimeSpan(10, 0, 0), EndTime = new TimeSpan(15, 0, 0), BookedBy = "Nova Marketing" },
                new Booking { BookingId = 6, EventId = 6, VenueId = 4, EventDate = new DateTime(2026, 8, 14), StartTime = new TimeSpan(17, 0, 0), EndTime = new TimeSpan(22, 0, 0), BookedBy = "Priya Naidoo" },
                new Booking { BookingId = 7, EventId = 7, VenueId = 5, EventDate = new DateTime(2026, 9, 3), StartTime = new TimeSpan(8, 0, 0), EndTime = new TimeSpan(16, 0, 0), BookedBy = "Apex Solutions HR" },
                new Booking { BookingId = 8, EventId = 8, VenueId = 1, EventDate = new DateTime(2026, 10, 18), StartTime = new TimeSpan(12, 0, 0), EndTime = new TimeSpan(22, 0, 0), BookedBy = "Live Beats Productions" }
            );
        }
    }
}
